...
app.post('/editCustomerData', (req, res) => {
  ...
  let sql = `UPDATE customers SET customer_name='${req.body.customer_name}', address=${req.body.address}, location=${req.body.location ? req.body.location : ''}, contact_name=${req.body.contact_name ? req.body.contact_name : ''}, contact_number=${req.body.contact_number ? req.body.contact_number : ''}, comments=${req.body.comments ? req.body.comments : ''} WHERE customer_id=${req.body.customer_id}`;
